...
const Schedule3 = lazy(() => {
  logger.debug('Loading Schedule3 component');
  return import('./pages/schedule/Schedule3');
});
...
function App() {
  ...
  useEffect(() => {
    ...
    router.addRoute('/schedule/schedule3', () => setCurrentPage('schedule3'));
